...
7. **Banned French AI-clichés sweep** (FR-01 list).
8. **Clue-phrase consistency** with your internal episode glossary
   (plant wording = payoff wording).
9. **Foisonnement respected** — natural French expansion, no compression to
   match English length; but expansion from syntax only, never padded
   content.
10. **Register:** Holmes = français soutenu; working-class = simple and
